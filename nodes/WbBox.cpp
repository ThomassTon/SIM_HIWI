...
void WbBox::collisionCallback(dGeomID box, dGeomID robot){
  // std::cerr<<A<<":   test\n\n\n\n\n\n\n\n\n\n"<<std::endl;
    if(box==A&&dGeomGetBody(robot)==robot_body)
    {
      std::cerr<<robot<<":   test\n\n\n\n\n\n\n\n\n\n"<<std::endl;
      dWebotsConsolePrintf(":   test\n\n\n\n\n\n\n\n\n\n");
    }
    
  

    // dGeomID A = dWebotsGetGeomFromDEF("flipper_front_right_link");
...
void WbBox::postFinalize() {
  ...
  // dGeomSetDynamicFlag(mOdeGeom);
  // std::cerr<<mOdeGeom<<":   test\n\n\n\n\n\n\n\n\n\n"<<std::endl;
  A = dWebotsGetGeomFromDEF("Box");
  B = dWebotsGetGeomFromDEF("flipper_front_left_joint");
  robot_body = dWebotsGetBodyFromDEF("flipper_front_right_link");
  std::cerr<<B<<":   test\n\n\n\n\n\n\n\n\n\n"<<std::endl;
