...
void WbSimulationCluster::odeNearCallback(void *data, dGeomID o1, dGeomID o2) {
  ...
  const bool isBoxGeom1 = dGeomGetClass(o1) == dBoxClass;
  const bool isBoxGeom2 = dGeomGetClass(o2) == dBoxClass;

  
  // std::cerr<<isBoxGeom1<<"    "<<isBoxGeom2<<"    "<<"\n\n\n\n\n\n\n\n\n\n\n\n";
  ...
  wg2 = odeGeomData2->geometry();
    ...
    // detect collison for box and robot
  if(isBoxGeom1&&(!isBoxGeom2))
  {
      // std::cerr<<isBoxGeom1<<"    "<<isBoxGeom2<<"    "<<"\n\n\n\n\n\n\n\n\n\n\n\n";
    // std::cerr<<s1<<"\n\n\n\n\n\n\n\n";
    WbBox *const b = dynamic_cast<WbBox *>(wg1);
    ...
    if(b){
      ...
      // if(s2->robot())
      // {
        b->collisionCallback(o2,o1);
      // }
    }
  }

  if(isBoxGeom2&&(!isBoxGeom1))
  {
    WbBox *const b = dynamic_cast<WbBox *>(wg2);
    if(b){
      // if(s1->robot())
      // {
        b->collisionCallback(o2,o1);
  ...
  // if(isBoxGeom1)
  // {
  //   WbBox *const b = dynamic_cast<WbBox *>(s1);
  //   if(b){
  //     b->collisionCallback(o1,o2);
  //   }
  //   return;
  // }
  ...
  // if(isBoxGeom2)
  // {
  //   WbBox *const b = dynamic_cast<WbBox *>(s2);
  //   if(b){
  //     b->collisionCallback(o2,o1);
  //   }
  //   return;
